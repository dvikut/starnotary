...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Star NFT";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        // costs less if check is later
        require(owner1Address == msg.sender || owner2Address == msg.sender, "You have to be the owner of at least one of the stars");
        // we are in a transaction, if one fails both fails
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You have to own the star to transfer");
